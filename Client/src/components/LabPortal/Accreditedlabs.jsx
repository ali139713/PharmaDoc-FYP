...
class AccreditedLabs extends Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      filteredLabs = response.data.labs.filter((t) => t.status === "Approved");
      this.setState({ labs: filteredLabs });
    } catch (error) {}
  }
    ...
    return (
      <div id="maindiv" className="container-fluid">
        ...
        <div className="form-holder">
          ...
          <p>
            {" "}
            Now ordering lab tests at your finger tips. Follow this simple 4
            step process to place your order..
          </p>
