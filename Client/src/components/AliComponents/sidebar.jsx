            ...
            <div className='row'>
                ...
                <div className='col-md-10 dashboard-right-block'>
                    <div className="container-fluid col md-4">
                        <h2 style={{ marginTop: "20px", marginLeft: "28%", fontStyle: "italic" }}> Welcome to Admin portal...</h2>
                        ...
                        <div className="cardsholder2">
                            ...
                            <div className="card1right">
                                <h3 style={{ marginLeft: "3%" }}> Total No of User: {medcount}</h3>
                            </div>

                            <p style={{ color: "transparent" }}> asd</p>

                            <div className="card2left">
                                <i className="fas fa-credit-card" style={{ fontSize: "5rem" }}></i>
                            </div>
                            <div className="card2right">
                                <h3 style={{ marginLeft: "3%" }}> Total No of Orders: {ordercount}</h3>
                            </div>
